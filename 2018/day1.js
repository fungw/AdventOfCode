...
function frequencyAccumalator(frequency, totalResult) {
  ...
  frequency.forEach(function(value) {
    ...
    insertHash(result, value);
  });
  if (FOUND === false) {
    return frequencyAccumalator(frequency, result);
  }
  return result;
}

function insertHash(result, value) {
...
console.log(frequencyAccumalator(data, 0));